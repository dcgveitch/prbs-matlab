                                ...
                                for d_dt=1:d_ndt
                                    for d_flow1=1:d_nFlow1
                                        for d_flow2=1:d_nFlow2
                                            ...
                                            outB_resultsCombined{ind_1,ind_2,ind_3,d_solve,d_impulse,d_nSeqA,d_tSeqA,d_conc,d_flowType}{end+1,1}=[d_batchRun(ref_bPerm) d_flowCount d_dt d_flowProcessP(2,d_dt) abs(d_flowProcessP(2,d_dt))/d_flowTotal(d_dt)/d_ndt/d_nNoise]; 
